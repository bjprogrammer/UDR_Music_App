...
public class music extends Fragment {
    ...
    private AudioAdapter mAdapter1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter1 = new AudioAdapter(audioList);
        ...
        recyclerView1.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView1, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                Audio movie = audioList.get(position);
    ...
    class JSONP extends AsyncTask<Void,Void,String>
    {
        ...
        protected void onPreExecute() {
            ...
            audioList.clear();
            jsonurl="http://sixthsenseit.com/toshow/udr/music.php";
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                for(int i=0; i < jsonArray.length(); i++)
                {
                    ...
                    Audio movie = new Audio(title, artist,year);
                    audioList.add(movie);
