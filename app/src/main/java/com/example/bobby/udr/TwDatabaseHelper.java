...
public class TwDatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="udrtwsignin.db";
    public static final String Table_Name="udrtwsignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table udrtwsignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,logout Text,twid Text, twname TEXT,twpic TEXT)");
    }
